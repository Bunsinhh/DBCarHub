...
namespace CarHub
{
    public partial class FormLogin : Form
    {
        ...
        SqlConnection cn = new SqlConnection("Data Source=NAMWOON;Initial Catalog=DBCARHUB;User ID=sa;Password=koko");
        //string str;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string str = "SELECT * FROM tblStaff WHERE UserName COLLATE SQL_Latin1_General_CP1_CS_AS = @UserName AND Password COLLATE SQL_Latin1_General_CP1_CS_AS = @Password";
