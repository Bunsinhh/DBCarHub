...
namespace CarHub
{
    public partial class FormIncome : Form
    {
        ...
        private void btPrint_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "Income Statement";
            printer.SubTitle = string.Format("\n"+ "Daily: " + txtDaily.Text + "\t              Weekly: " + txtWeekly.Text + "\t              Monthly: " + txtMonthly.Text + "\n\nDialy sale record", printer.SubTitleColor = Color.Black, printer);
            printer.SubTitleSpacing = 30;
            printer.SubTitleFormatFlags = StringFormatFlags.NoClip | StringFormatFlags.NoClip;
            printer.PageNumbers = true;
            printer.PageNumberInHeader = false;
            printer.PorportionalColumns = true;
            //printer.SubTitle = "Daily: " + txtDaily.Text + "\t              Weekly: " + txtWeekly.Text + "\t              Monthly: " + txtMonthly.Text;
            printer.FooterSpacing = 5;
            printer.PrintPreviewDataGridView(dataGridViewSellRecord);
        }
    }
}
